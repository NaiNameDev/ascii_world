...
#define rock			new_item('r', DEF, DEF, init_string(4, "rock"), 1, 1)

#define wood			new_item('W', YELLOW, YELLOW, init_string(4, "wood"), 1, 1)
#define rock_wall		new_item('W', DEF, DEF, init_string(9, "rock wall"), 1, 1)


//floor blocks
#define bery			new_item('@', RED, RED, init_string(4, "bery"), 1, 2)
